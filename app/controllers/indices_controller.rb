class IndicesController < ApplicationController
  ...
  def create
    ...
    @index.main_image.attach(params["index"]["main_image"])
    @index.main_image.attached?
  ...
  private
    ...
    def set_index
      @index = Index.friendly.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def index_params
      params.require(:index).permit(:main_image)
    end
end
